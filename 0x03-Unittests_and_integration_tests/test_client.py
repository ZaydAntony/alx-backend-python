  ...
  #Test cases for GithubOrgClient"""
    ...
    def test_public_repos_url(self):
        ...
        with patch.object(
            ...
            mock_org.return_value = {"repos_url": "https://api.github.com/orgs/test"}
    ...
    def test_public_repos(self, mock_get_json):
        #Test GithubOrgClient.public_repos returns the list of repo names"""
    ...
    def test_has_license(self, repo, license_key, expected):
      #Test GithubOrgClient.has_license behaves as expected"""
        client = GithubOrgClient("test")
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        #Set up mock requests before tests"""
